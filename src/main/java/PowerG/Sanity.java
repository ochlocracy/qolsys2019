...
public class Sanity extends Setup {
    ...
    //@Test
    public void Sensors_Sync() throws Exception {
        ...
        Thread.sleep(1000);
        pgprimaryCall(120, 1411, PGSensorsActivity.MOTIONIDLE);
        Thread.sleep(1000);
        pgprimaryCall(123, 1441, PGSensorsActivity.MOTIONIDLE);
        Thread.sleep(1000);
        pgprimaryCall(122, 1423, PGSensorsActivity.MOTIONIDLE);
        Thread.sleep(1000);
        pgprimaryCall(120, 1445, PGSensorsActivity.MOTIONIDLE);
        Thread.sleep(1000);
        pgprimaryCall(123, 1446, PGSensorsActivity.MOTIONIDLE);
        Thread.sleep(1000);
        pgprimaryCall(201, 1541, PGSensorsActivity.SMOKEMREST);
        Thread.sleep(1000);
        pgprimaryCall(200, 1531, PGSensorsActivity.SMOKEMREST);
        Thread.sleep(1000);
        pgprimaryCall(220, 1661, PGSensorsActivity.COREST);
        Thread.sleep(1000);
        pgprimaryCall(171, 1741, PGSensorsActivity.SHOCKREST);
        Thread.sleep(1000);
        pgprimaryCall(171, 1771, PGSensorsActivity.SHOCKREST);
        Thread.sleep(1000);
        pgprimaryCall(160, 1874, PGSensorsActivity.GBREST);
        Thread.sleep(1000);
        pgprimaryCall(160, 1871, PGSensorsActivity.GBREST);
        Thread.sleep(1000);
        pgprimaryCall(241, 1971, PGSensorsActivity.FLOODREST);
        Thread.sleep(1000);
        pgprimaryCall(400, 1995, PGSensorsActivity.TAMPERREST);
        Thread.sleep(1000);
        pgprimaryCall(410, 1998, PGSensorsActivity.TAMPERREST);
        Thread.sleep(1000);
        pgprimaryCall(250, 3030, PGSensorsActivity.TAMPERREST);
        Thread.sleep(1000);
        pgprimaryCall(250, 3131, PGSensorsActivity.TAMPERREST);
        Thread.sleep(1000);
        pgprimaryCall(300, 1004, PGSensorsActivity.TAMPERREST);
        Thread.sleep(1000);
        pgprimaryCall(305, 1009, PGSensorsActivity.TAMPERREST);
        Thread.sleep(1000);
        pgprimaryCall(306, 1003, PGSensorsActivity.TAMPERREST);
        Thread.sleep(1000);
        pgprimaryCall(371, 1005, PGSensorsActivity.TAMPERREST);
        Thread.sleep(1000);
        pgprimaryCall(371, 1006, PGSensorsActivity.TAMPERREST);
        Thread.sleep(1000);
        pgprimaryCall(371, 1008, PGSensorsActivity.TAMPERREST);
        Thread.sleep(1000);
        pgprimaryCall(320, 1015, PGSensorsActivity.TAMPERREST);
        Thread.sleep(1000);
        pgprimaryCall(320, 1016, PGSensorsActivity.TAMPERREST);
        Thread.sleep(1000);
        pgprimaryCall(320, 1018, PGSensorsActivity.TAMPERREST);
        Thread.sleep(1000);
        pgprimaryCall(320, 1105, PGSensorsActivity.TAMPERREST);
        Thread.sleep(1000);
        pgprimaryCall(320, 1116, PGSensorsActivity.TAMPERREST);
        Thread.sleep(1000);
        pgprimaryCall(320, 1207, PGSensorsActivity.TAMPERREST);
    }

    @Test(priority = 1)
    public void Add_Sensor() throws Exception {
        create_report("Sanity_01.add_sensor");
        ...
        Assert.assertTrue(driver.findElement(By.id("com.qolsys:id/t3_home_iv_SensorStatus")).isDisplayed());
        log.log(LogStatus.PASS, ("Pass: 'not networked' status icon is displayed"));
        activation_restoration(104, 1101, PGSensorsActivity.INOPEN, PGSensorsActivity.INCLOSE);//gr10
        try {
            if (driver.findElement(By.id("com.qolsys:id/t3_home_iv_SensorStatus")).isDisplayed()) {
                log.log(LogStatus.FAIL, ("Fail: 'not networked' status icon is displayed"));
                System.out.println("Fail: 'not networked' status icon is displayed");
            }
        } catch (NoSuchElementException e) {
            log.log(LogStatus.PASS, ("Pass: 'not networked' status icon is not displayed"));
            System.out.println("Pass: 'not networked' status icon is not displayed");
    ...
    public void Edit_Name() throws InterruptedException, IOException {
        add_to_report("Sanity_02.edit_sensor");
    ...
    public void Delete_Sensor() throws InterruptedException, IOException {
        ...
        add_to_report("Sanity_03.delete_sensor");
        ...
        try {
            ...
            System.out.println(webname.getText());
    ...
    public void contactSensorCheck() throws Exception {
        RemoteToolkitVariables remote = PageFactory.initElements(adc.driver1, RemoteToolkitVariables.class);
        add_to_report("Sanity_04.contact_sensor");
    ...
    public void motionSensorCheck() throws Exception {
        add_to_report("Sanity_05.motion_sensor");
    ...
    public void smokeCOSensorCheck() throws IOException, InterruptedException {
        add_to_report("Sanity_06.smoke_CO_sensor");
    ...
    public void waterSensorCheck() throws Exception {
        add_to_report("Sanity_07.water_sensor");
    ...
    public void shockSensorCheck() throws Exception {
        add_to_report("Sanity_08.shock_sensor");
    ...
    public void glassbreakSensorCheck() throws Exception {
        add_to_report("Sanity_09.glassbreak_sensor");
    ...
    public void keyfobKeypadPendantCheck() throws Exception {
        add_to_report("Sanity_10.keyfob_Aux_sensor");
    ...
    public void Tamper() throws IOException, InterruptedException {
        add_to_report("Sanity_11.tamper_sensor");
    ...
    public void Supervisory() throws IOException, InterruptedException {
        add_to_report("Sanity_12.supervisory_verification");
    ...
    public void Jam() throws Exception {
        add_to_report("Sanity_13.jam_event_verification");
    ...
    public void Low_Battery() throws InterruptedException, IOException {
        ...
        add_to_report("Sanity_14.low_battery");
